...
<body>
	...
	<div class="container-contact100">
        ...
        <div class="wrap-input100 validate-input">
					...
					<input id="name" class="input100" type="text" name="brand_title" placeholder="Enter Category Name..." required>
					<span class="focus-input100"></span>
				</div>


				<div class="container-contact100-form-btn">
					<button class="contact100-form-btn" name="insert_brand">
						Insert Brand
					</button>
				</div>
...
<?php
  ...
  if(isset($_POST['insert_brand'])){
    ...
    VALUES ('$category_name')";
		...
		$insert_brand_name = mysqli_query($con, $insert_brand);
